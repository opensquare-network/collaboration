...
export default function IdentityIcon({
  ...
  const AuthIcon = <img src="public/imgs/icons/identity/auth.svg" alt="" />;
  const SubIcon = <img src="public/imgs/icons/identity/sub.svg" alt="" />;
  const ErrorIcon = <img src="public/imgs/icons/identity/error.svg" alt="" />;
  const UnauthorizedIcon = (
    <img src="public/imgs/icons/identity/error-grey.svg" alt="" />
  );
  const SubGreyIcon = (
    <img src="public/imgs/icons/identity/sub-grey.svg" alt="" />
  );
  const SubRedIcon = (
    <img src="public/imgs/icons/identity/sub-red.svg" alt="" />
  );
