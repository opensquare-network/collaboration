...
async function getStellaSwapAddressBalance(network, contract, address, height) {
  ...
  url += `/evm/chain/${network}/stellaswap/contract/${contract}/address/${address}/height/${height}`;
